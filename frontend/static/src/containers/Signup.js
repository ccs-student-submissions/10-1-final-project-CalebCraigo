      ...
      <React.Fragment>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <p>
            ...
            <input className='passwordinput' id='password' type='password' name='password1' value={this.state.password} onChange={this.handleChange} placeholder='Enter password' required/>
          </p>
          <p>
            <label htmlFor="password">Password</label>
            <input className='passwordinput' id='password2' type='password' name='password2' value={this.state.password2} onChange={this.handleChange} placeholder='Enter password again' required/>
          </p>
